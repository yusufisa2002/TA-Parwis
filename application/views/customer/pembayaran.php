	...
	<div class="row">
					...
					<table class="table">
						<?php foreach($transaksi as $tr) : ?>
							...
							<tr>
								...
								<td></td>
								<td>
									<a href="<?php echo base_url('customer/transaksi/cetak_invoice/' . $tr->id_rental) ?>" class="btn btn-sm btn-primary" target="_blank">Print Invoice</a>
								</td>
							</tr>
		...
		<div class="col-md-4">
			<div class="card" style="margin-top: 110px">
				...
				<div class="card-body">
					<p class="text-success mb-3"> Silakan Melakukan Pembayaran Melalui Rekening di Bawah Ini: </p>

					<ul class="list-group list-group-flush">

						<?php foreach ($rekening as $pm ) : ?>
							<li class="list-group-item font-bold"><?php echo $pm->nama_rekening . '<br> ' . $pm->no_rekening ?> a.n. <?php echo $pm->atas_nama ?></li>
						<?php endforeach; ?>
					...
					<?php if(empty($tr->bukti_pembayaran)) { ?>	
						...
						<button style="width: 100%" type="button" class="btn btn-primary btn-sm mt-3" data-toggle="modal" data-target="#exampleModal">
