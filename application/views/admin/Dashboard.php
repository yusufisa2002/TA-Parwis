        ...
        <section class="section">
          ...
          <div class="row">
            <div class="col-lg-12 col-md-12 col-12 col-sm-12">
              <div class="card">
                <div class="card-header">
                  <h4 class="text-dark">Transaksi Terbaru</h4>
                </div>
                <div class="card-body">
                    ...
                    <?php foreach ($transaksi as $tr) : ?>
                      <li class="media">
                        <div class="media-body">
                          <div class="float-right text-muted">Rental #<?php echo $tr->id_rental ?></div>
                  ...
                  <div class="text-center pt-1 pb-1">
                    <a href="<?php echo base_url('admin/transaksi') ?>" class="btn btn-dark btn-lg btn-round">
                      Lihat Semua
                    </a>
                  </div>
                </div>
