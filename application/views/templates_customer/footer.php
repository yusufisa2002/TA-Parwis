                ...
                <div class="row">
                    ...
                    <div class="col-lg-6 col-md-6">
                        <div class="single-footer-widget">
                            ...
                            <div class="widget-body">
                                <img src="<?php echo base_url() ?>assets/assets_shop/img/logo-parwis.png" alt="JSOFT">
                                <p>Parwis Transport adalah Pintu penghubung antara penyedia rental dengan customer. Sebuah marketplace untuk penyedia rental dan customer untuk saling terhubung.</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-6 col-md-6">
                        <div class="single-footer-widget">
                            <h2>Hubungi Kami</h2>
                            <div class="widget-body">
                                <p>Hubungi kami untuk mengetahui lebih banyak. Dapatkan layanan terbaik dan prioritas dari kami, Parwis Transport.</p>

                                <ul class="get-touch">
                                    <li><i class="fa fa-map-marker"></i> Jl. Gedawang, Semarang</li>
                                    <li><i class="fa fa-mobile"></i> +62 811 1111 1111</li>
                                    <li><i class="fa fa-envelope"></i> lparwistransport@gmail.com</li>
                                </ul>
